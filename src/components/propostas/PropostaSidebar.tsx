...
export function PropostaSidebar({ proposta, clientes, membros, onUpdate }: Props) {
  return (
    <div className="w-80 border-l border-[var(--t-border)] bg-[var(--t-surface)] overflow-y-auto shrink-0 hidden lg:block">
