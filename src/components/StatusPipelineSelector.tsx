...
const OPTIONS: Array<{
  ...
  },
  {
    ...
    classes: { badge: 'bg-amber-100 text-amber-700 dark:bg-amber-500/20 dark:text-amber-300', dot: 'bg-amber-500', hover: 'hover:bg-amber-50 dark:hover:bg-amber-500/10' },
  },
  {
    key: 'VENDA',
    label: 'Venda',
