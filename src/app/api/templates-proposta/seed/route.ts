...
const TEMPLATES: Omit<TemplateProposta, 'id'>[] = [
  {
    ...
    visual: {
      cor_primaria: '#e11d48', cor_secundaria: '#0a0a14', cor_texto: '#ffffff',
  ...
  },
  {
    ...
    visual: {
      cor_primaria: '#059669', cor_secundaria: '#0a0a14', cor_texto: '#ffffff',
  ...
  },
  {
    ...
    visual: {
      cor_primaria: '#7c3aed', cor_secundaria: '#0a0a14', cor_texto: '#ffffff',
  ...
  },
  {
    ...
    visual: {
      cor_primaria: '#0284c7', cor_secundaria: '#0a0a14', cor_texto: '#ffffff',
  ...
  },
  {
    ...
    visual: {
      cor_primaria: '#1e293b', cor_secundaria: '#0a0a14', cor_texto: '#ffffff',
  ...
  },
  {
    ...
    visual: {
      cor_primaria: '#0891b2', cor_secundaria: '#0a0a14', cor_texto: '#ffffff',
